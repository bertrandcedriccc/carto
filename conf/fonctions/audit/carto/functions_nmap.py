...
def recup_domains_not_scanned(domaine, dir_rapport, file_domaine):
    ...
    nb_domaines_total = 0
    nb_domaines_scanned = 0 
    with open(file_domaine, 'r') as f:
        for line in f:
            sousdomaine = line.rstrip('\n\r')
            nb_domaines_total = nb_domaines_total + 1
            ...
            else:nb_domaines_scanned = nb_domaines_scanned  + 1
    ...
    print ("\nNombre total de domaines : " + str(nb_domaines_total) + " / nombre de domaines scannes : " +str(nb_domaines_scanned)+"\n")
